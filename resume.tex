...
\resumeItemListStart
\resumeItem{Lead logistics to set up our non-profit tutoring organization during COVID-19 remote instruction.}
...
\resumeItemListStart
\resumeItem{Developed a package to round raw values produced by specialists and manufacturers to meet federal compliance standards set by the FDA and NDC. 6,000+ downloads with an in-progress dietary calculator.}
\resumeItemListEnd
\vspace{-13pt}
\resumeProjectHeading
