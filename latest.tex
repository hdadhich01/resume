...
\begin{itemize}[leftmargin=0.15in, label={}]
	\small{\item{
		            ...
		            \textbf{Tools}{: Canva, Google Workspace, MS Office, Git, Ubuntu Linux} \\
		            \textbf{Libraries}{: Angular, React, BeautifulSoup, FastAPI, Flask} \\
		            \textbf{Platforms}{: Cloudflare, Digital Ocean, GitHub, Heroku, Oracle Cloud} \\
		      }}
\end{itemize}
\vspace{-15pt}
...
\resumeItem{Mentored by Associate Vice Chancellors and the ITS department to draft out an information database}
\resumeItemListEnd
...
\resumeItemListStart
\resumeItem{Redesigned a promotional page for a mobile ophthalmology app increasing downloads and signups by \textbf{$\sim$30\%}}
\resumeItem{Leveraged React and Firebase to create responsive components displaying user-inputted data}
\resumeItemListEnd

\resumeSubheading
{Tech4Good Lab}{Apr 2023 -- Present}
...
\resumeItem{Received \textbf{10k+ downloads} and working to integrate a dietary calculator with different meal plans}
\resumeItemListEnd
...
\resumeItemListStart
\resumeItem{Produced a live \textbf{RESTful API} to deliver \textbf{scraped} and organized data catering to my \textbf{university's services} for instructional catalog, dining, laundry, and other utilities}
...
\resumeItemListStart
\resumeItem{Selected as 1 of 90 Campus Experts in a competitive pool of over 6,000 applicants around the globe}
