...
\resumeItemListStart
\resumeItem{Developed a package to round nutritional value data to comply with FDA and NDC standards and regulations.}
\resumeItem{Received 6,000+ downloads and working to create a dietary calculator with different meal plans.}
\resumeItemListEnd
...
\resumeItemListStart
\resumeItem{Competed with teammates in an innovation ideation challenge and addressed institutional funding inequality.}
...
\begin{itemize}[leftmargin=0.15in, label={}]
	\small{\item{
		            \textbf{Languages}{: Python, C\texttt{++}, Java, HTML/CSS, JavaScript, \LaTeX} \\
		            \textbf{Tools}{: Canva, Google Workspace, Git/GitKraken, PuTTY, WinSCP, WSL, UNIX} \\
