...
\begin{itemize}[itemsep=-1pt, parsep=1pt]
	\item\small \textbf{GPA}{: 4.0} --- \textbf{Awards}{: Dean's Honors List (x2): Fall 2022, Spring 2023} -- \textbf{Coursework}{:  Prog Abs: Python,  Com Sys/Assmbly Lan, FoundationsGameDesgn,  Comp Sys and C Prog, Appl Discrete Math, Vector Calculus}
\end{itemize}
...
\begin{itemize}[leftmargin=0.15in, label={}]
	\small{\item{
		            \textbf{Languages}{: Python, C/C\texttt{++}, Java, TypeScript, HTML/CSS, Markdown, \LaTeX} \\
		            \textbf{Tools}{: Canva, Google Workspace, MS Office, Git, PuTTY, WinSCP, Ubuntu Linux} \\
		            \textbf{Libraries}{: Angular, BeautifulSoup, discord.py, FastAPI, Flask/Quart} \\
		            \textbf{Platforms}{: Cloudflare, Digital Ocean, GitHub, Heroku, Oracle Cloud, PyPI} \\
		      }}
\end{itemize}
\vspace{-15pt}
...
\resumeSubheading
{Tech4Good Lab}{Apr 2023 -- current}
{Undergraduate Research Assistant: Web Development Team}{Santa Cruz, CA}
\resumeItemListStart
\resumeItem{Converted prototyped designs into functioning and interactive Angular components on the ExploreCareers project}
\resumeItem{Performed component testing and bug fixes to ensure proper integration with supporting NgRx containers}
\resumeItemListEnd
