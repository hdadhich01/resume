...
\resumeItemListStart
\resumeItem{Developed a package to round nutritional value data to comply with FDA and NDC regulations}
\resumeItem{Received \textbf{10k+ downloads} from popular open source projects for use in nutritional interfaces and calculators}
\resumeItemListEnd
...
\resumeItemListStart
\resumeItem{Produced a live RESTful API to deliver data on university's services for instructional catalog, dining, laundry, etc.}
\resumeItem{Streamlined deployment on a remote endpoint with CI/CD and used SEO practices for a \textbf{20\%} traffic increase}
...
\resumeItem{Increased community productivity by \textbf{25\%} with features such as media processing, reminders, and alerts}
\resumeItemListEnd
